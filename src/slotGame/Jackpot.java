...
public class Jackpot {
    private String name; // Име на нивото (напр. Minor, Major, Mega)
    private double baseValue; // Базова стойност на джакпота
    private double incrementPercentage; // Процент за инкремент от залога
    private double minPayoutValue; // Минимална стойност за падане
    private double maxPayoutValue; // Максимална стойност за падане
    private double currentValue; // Текуща стойност на джакпота

    public Jackpot(String name, double baseValue, double incrementPercentage, double minPayoutValue, double maxPayoutValue) {
        this.name = name;
    ...
    public void setBaseValue(double baseValue) {
        ...
        if (currentValue < baseValue) {
            currentValue = baseValue; // Уверяваме се, че текущата стойност не пада под базовата
        }
    }
